...
#additional of 2 diagonal units
...
def naked_twins(values):
    ...
    """
    #traverse each unit..find box values with length 2
    #create a dictionary with value and count..get a list from this dictionary which filters values with count 2
    #traverse each unit..for each value in this list...for each digit in this value..if box value is same as the 
    #list item value...ignore it...else for remaining values...remove the list item digits from the box value
